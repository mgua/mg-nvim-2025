...
-- Strategy selection (windows/tmux/osc52/local), startup verification with
-- actionable error messages, and the :ClipboardStatus diagnostic command.
require("config.clipboard")      -- (lua/config/clipboard.lua)
