...
2. Install Git:
	...
	```
	the ~/.gitconfig contents tell git its basic configuration for your user:
	here is an example:
    ...
    [core]
        # sshCommand = ssh -i c:/Users/mgua/.ssh/id_rsa_mgua
...
4. Install LazyGit:
	...
	```
    **Need to describe lazygit configuration here!!**
